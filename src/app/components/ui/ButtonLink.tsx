...
export default function ButtonLink({text, icon, textColor, bgColor, className}: ButtonProps) {
  ...
  return (
    <span
      className={clsx(
        // Sensible defaults
        "inline-flex items-center justify-center rounded-full font-semibold transition-all duration-200 ease-in-out",
        "bg-[#f47c2c] text-white hover:opacity-85 hover:shadow-sm",
