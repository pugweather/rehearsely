...
const MicErrorModal = ({ isOpen, onClose }: Props) => {
  ...
  return (
    <Modal width={520} height={220} isOpen={isModalOpen} onClose={handleClose}>
      <div className='flex flex-col h-full rounded-2xl' style={{backgroundColor: '#E3D6C6', border: '1px solid rgba(32,32,32,0.1)'}}>
        <div className='relative px-6 py-5'>
          <div className='text-xl font-semibold' style={{color: '#202020'}}>Microphone Access Required</div>
