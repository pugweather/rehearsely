...
const LoadingLine = ({ characterName, order }: LoadingLineProps) => {
  return (
    <div className="relative group">
      <div className="flex items-start gap-4 p-4 bg-white/50 rounded-lg border-2 border-gray-300">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 text-gray-600">
            <span className="text-sm italic">Loading line with audio</span>
